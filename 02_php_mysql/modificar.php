...
<head>
    ...
    <title>Curso de PHP | mayo de 2016 | modificar.php</title>
...
<!-- formulario de comentario -->
        ...
        <div>
            <label for="entrada_id">entrada_id:</label>
            <input type="text" id="entrada_id" name="entrada_id" value="<?php  ?>"/>
        </div>
    ...
    <?php
        ...
        $conexion = mysqli_connect("localhost", "root", "root", "blog");
        //hacemos
        $q = "insert into comentario values ( 0,'" . $email . "','" . $texto . "','" . $fecha . "','" . $activo . "','" . $entrada_id . "')";
